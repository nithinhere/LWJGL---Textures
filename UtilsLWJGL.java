...
public class UtilsLWJGL {
	...
	public static long openWindow(String title, int winW, int winH, String oglVersion) {
		...
		try {
			...
			System.err
					.println("Unexpected error in openWindow processing!\n" + "with version parameter: " + oglVersion);
		}
		return NULL;
	}
	 ...
	 * @throws IOException
	 */
	public static int makeShaderProgram(String vertexShader, String fragmentShader, String version) throws IOException {
